# Generated by Django 3.2 on 2021-05-23 09:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='story_viewed_user', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notif_type', models.CharField(choices=[('seen', 'seen'), ('received', 'received'), ('s_reached', 's_reached')], max_length=10)),
