# Generated by Django 3.2 on 2021-05-21 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('views', models.ManyToManyField(related_name='story_views', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Thread',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notif_type', models.CharField(choices=[('story_add', 'story_add'), ('story_del', 'story_del')], max_length=15)),
                ('time_created', models.CharField(max_length=20)),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='story_viewed_user', to=settings.AUTH_USER_MODEL)),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chat.story')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('people_i_peek', models.ManyToManyField(related_name='watching', to=settings.AUTH_USER_MODEL)),
                ('people_i_should_inform', models.ManyToManyField(related_name='cctvs', to=settings.AUTH_USER_MODEL)),
