...
import 'package:foo/stories/video_trimmer/video_editor_api/domain/entities/crop_style.dart';
import 'package:foo/stories/video_trimmer/video_editor_api/domain/entities/trim_style.dart';
...
class VideoEditorController extends ChangeNotifier {
  ...
  Future<File> exportVideo({
    ...
    final String execute =
        " -i $videoPath ${customInstruction ?? ""} ${_getPreset(preset)} $trim -y $outputPath";
