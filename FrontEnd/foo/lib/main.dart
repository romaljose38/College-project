...
class TestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:this.done?Center(child:Image.file(this.file)):Center(child:Text("hello")),
      floatingActionButton: IconButton(icon:Icon(Icons.add),color: Colors.black,onPressed: () async{
        FilePickerResult result = await FilePicker.platform.pickFiles();
        print(result);
        File file = File(result.files.single.path);
        Navigator.push(context,MaterialPageRoute(builder:(_)=>VideoApp(file:file)));
